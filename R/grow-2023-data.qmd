...
## Oyster Size Figure
Fig_2_Oyster_Size <- oyster_custom_ggplot(oyst_size_summary_fig, "Oyster_Length_mm", y_axis_label = "Oyster Size (mm)", y_axis_min = 0, y_axis_max = 30)

Fig_2_Oyster_Size

ggsave("../plots/Fig_2_oyster_size.pdf", width = 8.5, height = 6.5, units = "in")
