...
oyst_abundance_summary_tile <- oyst_abundance_summary_tile %>%
  ...
  mutate(data_type = ifelse(Tile_Type == "Control", "Unseeded Tile",
                            ifelse(Tile_Type == "No-predator", "No-Pred Tile",
...
oyst_abundance_summary_plot <- oyst_abundance_summary_plot %>%
  mutate(data_type = ifelse(Tile_Type == "Control", "Unseeded Plot",
                            ifelse(Tile_Type == "No-predator", "No-Pred Plot",
...
oyst_abundance_summary_fig$data_type <- factor(oyst_abundance_summary_fig$data_type, levels = c("Unseeded Tile","Unseeded Plot", "No-Pred Tile", "No-Pred Plot", "Predator Tile", "Predator Plot", "Overall Plot"))
...
### return to seagrass data and figure and remake in this same configuration?? - need to figure out why those canopy height points are being plotted incorrectly.
...
Fig_1_Oyster_Abundance
ggsave("../plots/Fig_1_oyster_abundance.pdf", width = 8.5, height = 6, units = "in")
